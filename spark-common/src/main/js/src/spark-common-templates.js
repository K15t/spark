 ...
 * @param className
 */
const appFullscreenContaineriFrame = function({ id, createOptions, className }) {
    return `
        <div id="${id}" 
        ...
        `<div class="spark-fullscreen-chrome">
            ...
            ` : ''}
            <div id="${id + '-iframe-container'}" class="spark-fullscreen-scroll-wrapper ${createOptions.addChrome ? "spark-fullscreen-haschrome" : ""}">
            </div>
        </div>
    `;
};
 ...
 * @returns {string}
 */
const inlineDialogAppContainer = function({ id, createOptions, className }) {
    return `
...
const bootstrappedIFrame = function({ id, src, createOptions, className }) {
    return `
        <iframe id="${id}-iframe" class="${className} spark-fullscreen-iframe" src="${src}" scrolling="no">
        </iframe>
    `;
};
